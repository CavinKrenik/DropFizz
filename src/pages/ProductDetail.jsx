...
const PRODUCT_DATA = {
  ...
  'holiday-kit': { name: 'Holiday Kit (12 pack)', description: 'Festive scents perfect for gifting.', ingredients: 'Assorted: peppermint, pine, cinnamon, citrus.', price: 23.99, image: '/holiday.jpg' },

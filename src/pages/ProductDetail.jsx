...
const PRODUCT_DATA = {
  ...
  'holiday-kit': { name: 'Holiday Kit (24 pack)', description: 'Festive scents perfect for gifting.', ingredients: 'Assorted: peppermint, pine, cinnamon, citrus.', price: 35.99, image: '/holiday.jpg' },
